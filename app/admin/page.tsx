...
export default function AdminPage() {
  ...
  if (!token) {
    return (
      <div className="flex flex-1 items-center justify-center bg-[#ebebeb] px-4 py-16 dark:bg-black">
        <main className="w-full max-w-md rounded-md border border-zinc-200 bg-white p-8 dark:border-white/10 dark:bg-zinc-950">
          ...
          <form onSubmit={handleLogin} className="mt-8 flex flex-col gap-3">
            ...
            <input
              ...
              className="rounded-md border border-zinc-300 bg-white px-4 py-2.5 text-zinc-950 outline-none focus:border-[#3483fa] dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
            />
            ...
            <button
              ...
              className="mt-2 rounded-md bg-[#3483fa] px-4 py-2.5 font-semibold text-white hover:bg-[#2968c8] disabled:cursor-not-allowed disabled:opacity-50"
            >
  ...
  return (
    <div className="flex flex-1 flex-col bg-[#ebebeb] px-4 py-10 dark:bg-black">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <input
          ...
          className="w-full rounded-md border border-zinc-300 bg-white px-4 py-2.5 text-zinc-950 outline-none focus:border-[#3483fa] dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
        />
              ...
              >
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-medium text-white ${
                          room.isPrivate ? "bg-red-600" : "bg-[#00a650]"
                        }`}
                      >
                  ...
                  <Link
                    ...
                    className="shrink-0 rounded-md bg-[#3483fa] px-3 py-2 text-sm font-semibold text-white hover:bg-[#2968c8]"
                  >
                    Visualizar
                  </Link>
                </div>

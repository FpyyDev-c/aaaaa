      ...
      <form onSubmit={handleSend} className="mt-4 flex flex-col gap-3">
        <div>
          ...
          <textarea
            ...
            className="mt-1 w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-950 outline-none focus:border-[#3483fa] dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
          />
        </div>
        ...
        <div className="mt-1 flex flex-wrap gap-2">
          ...
          <button
            ...
            className="rounded-md bg-[#3483fa] px-4 py-2 text-sm font-semibold text-white hover:bg-[#2968c8] disabled:cursor-not-allowed disabled:opacity-50"
          >
